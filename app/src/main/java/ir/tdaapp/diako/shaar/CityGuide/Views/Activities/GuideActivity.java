...
import ir.tdaapp.diako.shaar.CityGuide.Models.Repositories.Database.TblCityId;
...
public class GuideActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    tblCityId = new TblCityId(this);

    if (tblCityId.getCityId() <= 0) {
