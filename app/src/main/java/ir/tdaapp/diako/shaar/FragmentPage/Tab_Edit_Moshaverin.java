...
import ir.tdaapp.diako.shaar.Adapter.Edit_Moshaverin;
...
public class Tab_Edit_Moshaverin extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(ir.tdaapp.diako.shaar.R.layout.tab_edit_moshaverin,container,false);
    ...
    private List<List_Moshaverin> SetValue(){
        ...
        lst.add(new List_Moshaverin("محمد محمدی",1,false));
        lst.add(new List_Moshaverin("مظفر مظفری",0,true));
        lst.add(new List_Moshaverin("سینا مرادی",1,false));
        lst.add(new List_Moshaverin("حسین حسن",1,true));
        return lst;
    }

    private void SetMoshaverin(View view){
        recyclerView=view.findViewById(ir.tdaapp.diako.shaar.R.id.EditMoshaverin_Recycler);
        LinearLayoutManager linearLayoutManager=new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false);
        Edit_Moshaverin edit_moshaverin=new Edit_Moshaverin(SetValue(),getActivity());
