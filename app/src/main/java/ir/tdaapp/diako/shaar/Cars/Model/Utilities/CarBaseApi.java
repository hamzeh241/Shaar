...
public class CarBaseApi {
    ...
    public static final String API_IMAGE_CAR_EXPERT = "https://api.shaarapp.ir/ImageSave/";
    public static final String API_IMAGE_ADD_CAR = "https://api.shaarapp.ir/api/Car/PostImageCar";
}
